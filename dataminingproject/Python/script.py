...
chunka = pd.read_csv('2013-american-community-survey/pums//ss13pusa.csv', chunksize=1000, usecols=columns)
...
chunkb = pd.read_csv('2013-american-community-survey/pums//ss13pusb.csv', chunksize=1000, usecols=columns)
