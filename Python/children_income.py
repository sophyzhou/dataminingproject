...
housa=pd.read_csv("2013-american-community-survey/pums/ss13husa.csv", usecols=['HINCP', 'NRC', 'NPF'])
housb=pd.read_csv("2013-american-community-survey/pums/ss13husb.csv", usecols=['HINCP', 'NRC', 'NPF'])
